    ...
    >
      <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-16">
        <div className="inline-block mb-4">
          <div
            className="w-14 h-14 rounded-xl flex items-center justify-center glow"
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        {algorithms.map((algo) => (
          <Link
            key={algo.to}
            to={algo.to}
            className="category-card p-6 sm:p-8 group"
          >
            ...
            <h2
              className="text-xl sm:text-2xl font-semibold mb-2 group-hover:gradient-text transition-all"
              style={{ color: "hsl(var(--text-primary))" }}
            >
              {algo.title}
            </h2>
