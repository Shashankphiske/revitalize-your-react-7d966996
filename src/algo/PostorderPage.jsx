...
const PostorderPage = () => {
  ...
  useEffect(() => {
    ...
    const highlightedLine = (currentStepIndex > 0 && currentStepIndex <= steps.length) ? 4 : null;
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8 pt-25">
      ...
      <div className="flex justify-center">
        ...
        <div className="algo-code-panel">
          <CodeViewer code={POSTORDER_CODE} highlightedLine={highlightedLine} title="postorder.js" />
        </div>
      </div>
    </div>
  );
