...
const getHighlightedLine = (step) => {
  if (!step) return null;
  if (step.action === "dequeue-start") return 2;
  if (step.action === "dequeue-complete") return 2;
  return null;
};
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8 pt-25">
      ...
      <div className="algo-split-layout">
        ...
        <div className="algo-code-panel">
          <CodeViewer code={QUEUE_DEQUEUE_CODE} highlightedLine={highlightedLine} title="queue-dequeue.js" />
        </div>
      </div>
    </div>
  );
