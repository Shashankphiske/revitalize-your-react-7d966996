    ...
    <div className="min-h-screen pt-32 pb-16 px-6" style={{ color: 'hsl(0 0% 96%)' }}>
      ...
      <div className="max-w-6xl mx-auto">
        <AlgoVisualizationContainer>
          ...
          <div className="flex justify-center gap-6 mt-6 text-sm" style={{ color: 'hsl(220 10% 60%)' }}>
            <div className="flex items-center gap-2"><span className="w-4 h-4 rounded" style={{ background: 'hsl(220 60% 55%)' }} /> Unsorted</div>
            <div className="flex items-center gap-2"><span className="w-4 h-4 rounded" style={{ background: 'hsl(262 80% 55%)' }} /> Pivot</div>
            <div className="flex items-center gap-2"><span className="w-4 h-4 rounded" style={{ background: 'hsl(40 90% 55%)' }} /> Comparing</div>
            <div className="flex items-center gap-2"><span className="w-4 h-4 rounded" style={{ background: 'hsl(0 72% 55%)' }} /> Swapping</div>
          </div>
        </AlgoVisualizationContainer>
      </div>
    </div>
